...
$CS_1 = 0; // CANTIDAD ESTUDIANTES Identidad
$CS_2 = 0; // CANTIDAD ESTUDIANTES Autoestima
$CS_3 = 0; // CANTIDAD ESTUDIANTES Valores
$CS_4 = 0; // CANTIDAD ESTUDIANTES Manejo de Conflictos
$CS_5 = 0; // CANTIDAD ESTUDIANTES Cooperacion y Pertenencia
$CS_6 = 0; // CANTIDAD ESTUDIANTES Proteccion y Cuidados
$CS_7 = 0; // CANTIDAD ESTUDIANTES Manejo de la Convivencia
					...
					<div class='table-responsive'>
						<table id='json-table' class='tablesorter table table-striped'>
							...
							<tbody>
								<tr>
									<td>1</td>
									<td>Numero de estudiantes del mismo curso y establecimiento con puntaje distinto a nulo, en  Aplicación 1, en dimensión Identidad</td>
									<td><?php echo $NC_1; ?></td>
								</tr>
								<tr>
									<td>2</td>
									<td>Numero de estudiantes del mismo curso y establecimiento con puntaje distinto a nulo, en  Aplicación 1, en dimensión utoestima</td>
									<td><?php echo $NC_2; ?></td>
								</tr>
								<tr>
									<td>3</td>
									<td>Numero de estudiantes del mismo curso y establecimiento con puntaje distinto a nulo, en  Aplicación 1, en dimensión Valores</td>
									<td><?php echo $NC_3; ?></td>
								</tr>
								<tr>
									<td>4</td>
									<td>Numero de estudiantes del mismo curso y establecimiento con puntaje distinto a nulo, en  Aplicación 1, en dimensión Manejo de conflictos</td>
									<td><?php echo $NC_4; ?></td>
								</tr>
								<tr>
									<td>5</td>
									<td>Numero de estudiantes del mismo curso y establecimiento con puntaje distinto a nulo, en  Aplicación 1, en dimensión Cooperación y pertenencia</td>
									<td><?php echo $NC_5; ?></td>
								</tr>
								<tr>
									<td>6</td>
									<td>Numero de estudiantes del mismo curso y establecimiento con puntaje distinto a nulo, en  Aplicación 1, en dimensión Jerarquías protectoras: Protección y cuidado</td>
									<td><?php echo $NC_6; ?></td>
								</tr>
								<tr>
									<td>7</td>
									<td>Numero de estudiantes del mismo curso y establecimiento con puntaje distinto a nulo, en  Aplicación 1, en dimensión Jerarquías protectoras: Manejo de la convivencia</td>
									<td><?php echo $NC_7; ?></td>
								</tr>
								<tr>
									<td>8</td>
									<td>Cuenta estudiantes en el curso con nivel Preocupante en dimensión Identidad</td>
									<td><?php echo $CA_1; ?></td>
								</tr>
								<tr>
									<td>9</td>
									<td>Cuenta estudiantes en el curso con nivel Preocupante en dimensión utoestima</td>
									<td><?php echo $CA_2; ?></td>
								</tr>
								<tr>
									<td>10</td>
									<td>Cuenta estudiantes en el curso con nivel Preocupante en dimensión Valores</td>
									<td><?php echo $CA_3; ?></td>
								</tr>
								<tr>
									<td>11</td>
									<td>Cuenta estudiantes en el curso con nivel Preocupante en dimensión Manejo de conflictos</td>
									<td><?php echo $CA_4; ?></td>
								</tr>
								<tr>
									<td>12</td>
									<td>Cuenta estudiantes en el curso con nivel Preocupante en dimensión Cooperación y pertenencia</td>
									<td><?php echo $CA_5; ?></td>
								</tr>
								<tr>
									<td>13</td>
									<td>Cuenta estudiantes en el curso con nivel Preocupante en dimensión Jerarquías protectoras: Protección y cuidado</td>
									<td><?php echo $CA_6; ?></td>
								</tr>
								<tr>
									<td>14</td>
									<td>Cuenta estudiantes en el curso con nivel Preocupante en dimensión Jerarquías protectoras: Manejo de la convivencia</td>
									<td><?php echo $CA_7; ?></td>
								</tr>
								<tr>
									<td>15</td>
									<td>Porcentaje estudiantes en el curso con nivel Preocupante en dimensión Identidad</td>
									<td><?php if ($NC_1 == 0) echo "0.00%"; else echo sprintf('%0.2f%%', ($CA_1 / $NC_1) * 100); ?></td>
								</tr>
								<tr>
									<td>16</td>
									<td>Porcentaje estudiantes en el curso con nivel Preocupante en dimensión utoestima</td>
									<td><?php if ($NC_2 == 0) echo "0.00%"; else echo sprintf('%0.2f%%', ($CA_2 / $NC_2) * 100); ?></td>
								</tr>
								<tr>
									<td>17</td>
									<td>Porcentaje estudiantes en el curso con nivel Preocupante en dimensión Valores</td>
									<td><?php if ($NC_3 == 0) echo "0.00%"; else echo sprintf('%0.2f%%', ($CA_3 / $NC_3) * 100); ?></td>
								</tr>
								<tr>
									<td>18</td>
									<td>Porcentaje estudiantes en el curso con nivel Preocupante en dimensión Manejo de conflictos</td>
									<td><?php if ($NC_4 == 0) { echo "0.00%"; } else { echo sprintf('%0.2f%%', ($CA_4 / $NC_4) * 100); } ?></td>
								</tr>
								<tr>
									<td>19</td>
									<td>Porcentaje estudiantes en el curso con nivel Preocupante en dimensión Cooperación y pertenencia</td>
									<td><?php if ($NC_5 == 0) echo "0.00%"; else echo sprintf('%0.2f%%', ($CA_5 / $NC_5) * 100); ?></td>
								</tr>
								<tr>
									<td>20</td>
									<td>Porcentaje estudiantes en el curso con nivel Preocupante en dimensión Jerarquías protectoras: Protección y cuidado</td>
									<td><?php if ($NC_6 == 0) echo "0.00%"; else echo sprintf('%0.2f%%', ($CA_6 / $NC_6) * 100); ?></td>
								</tr>
								<tr>
									<td>21</td>
									<td>Porcentaje estudiantes en el curso con nivel Preocupante en dimensión Jerarquías protectoras: Manejo de la convivencia</td>
									<td><?php if ($NC_7 == 0) echo "0.00%"; else echo sprintf('%0.2f%%', ($CA_7 / $NC_7) * 100); ?></td>
								</tr>
								<tr>
									<td>22</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 1</td>
									<td><?php echo $CN_1; ?></td>
								</tr>
								<tr>
									<td>23</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 2</td>
									<td><?php echo $CN_2; ?></td>
								</tr>
								<tr>
									<td>24</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 3</td>
									<td><?php echo $CN_3; ?></td>
								</tr>
								<tr>
									<td>25</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 4</td>
									<td><?php echo $CN_4; ?></td>
								</tr>
								<tr>
									<td>26</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 5</td>
									<td><?php echo $CN_5; ?></td>
								</tr>
								<tr>
									<td>27</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 6</td>
									<td><?php echo $CN_6; ?></td>
								</tr>
								<tr>
									<td>28</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 7</td>
									<td><?php echo $CN_7; ?></td>
								</tr>
								<tr>
									<td>29</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 8</td>
									<td><?php echo $CN_8; ?></td>
								</tr>
								<tr>
									<td>30</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 9</td>
									<td><?php echo $CN_9; ?></td>
								</tr>
								<tr>
									<td>31</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 10</td>
									<td><?php echo $CN_10; ?></td>
								</tr>
								<tr>
									<td>32</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 11</td>
									<td><?php echo $CN_11; ?></td>
								</tr>
								<tr>
									<td>33</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 12</td>
									<td><?php echo $CN_12; ?></td>
								</tr>
								<tr>
									<td>34</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 13</td>
									<td><?php echo $CN_13; ?></td>
								</tr>
								<tr>
									<td>35</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 14</td>
									<td><?php echo $CN_14; ?></td>
								</tr>
								<tr>
									<td>36</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 15</td>
									<td><?php echo $CN_15; ?></td>
								</tr>
								<tr>
									<td>37</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 16</td>
									<td><?php echo $CN_16; ?></td>
								</tr>
								<tr>
									<td>38</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 17</td>
									<td><?php echo $CN_17; ?></td>
								</tr>
								<tr>
									<td>40</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 18</td>
									<td><?php echo $CN_18; ?></td>
								</tr>
								<tr>
									<td>41</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 19</td>
									<td><?php echo $CN_19; ?></td>
								</tr>
								<tr>
									<td>42</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 20</td>
									<td><?php echo $CN_20; ?></td>
								</tr>
								<tr>
									<td>43</td>
									<td>Cantidad de estudiantes con 'No' en afirmación 21</td>
									<td><?php echo $CN_21; ?></td>
								</tr>
								<tr>
									<td>44</td>
									<td>Proporción de estudiantes con 'No' en afirmación 1</td>
									<td><?php echo sprintf('%0.2f', $CN_1 / $cant); ?></td>
								</tr>
								<tr>
									<td>45</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 2</td>
									<td><?php echo sprintf('%0.2f', $CN_2 / $cant); ?></td>
								</tr>
								<tr>
									<td>46</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 3</td>
									<td><?php echo sprintf('%0.2f', $CN_3 / $cant); ?></td>
								</tr>
								<tr>
									<td>47</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 4</td>
									<td><?php echo sprintf('%0.2f', $CN_4 / $cant); ?></td>
								</tr>
								<tr>
									<td>48</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 5</td>
									<td><?php echo sprintf('%0.2f', $CN_5 / $cant); ?></td>
								</tr>
								<tr>
									<td>49</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 6</td>
									<td><?php echo sprintf('%0.2f', $CN_6 / $cant); ?></td>
								</tr>
								<tr>
									<td>50</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 7</td>
									<td><?php echo sprintf('%0.2f', $CN_7 / $cant); ?></td>
								</tr>
								<tr>
									<td>51</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 8</td>
									<td><?php echo sprintf('%0.2f', $CN_8 / $cant); ?></td>
								</tr>
								<tr>
									<td>52</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 9</td>
									<td><?php echo sprintf('%0.2f', $CN_9 / $cant); ?></td>
								</tr>
								<tr>
									<td>53</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 10</td>
									<td><?php echo sprintf('%0.2f', $CN_10 / $cant); ?></td>
								</tr>
								<tr>
									<td>54</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 11</td>
									<td><?php echo sprintf('%0.2f', $CN_11 / $cant); ?></td>
								</tr>
								<tr>
									<td>55</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 12</td>
									<td><?php echo sprintf('%0.2f', $CN_12 / $cant); ?></td>
								</tr>
								<tr>
									<td>56</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 13</td>
									<td><?php echo sprintf('%0.2f', $CN_13 / $cant); ?></td>
								</tr>
								<tr>
									<td>57</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 14</td>
									<td><?php echo sprintf('%0.2f', $CN_14 / $cant); ?></td>
								</tr>
								<tr>
									<td>58</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 15</td>
									<td><?php echo sprintf('%0.2f', $CN_15 / $cant); ?></td>
								</tr>
								<tr>
									<td>59</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 16</td>
									<td><?php echo sprintf('%0.2f', $CN_16 / $cant); ?></td>
								</tr>
								<tr>
									<td>60</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 17</td>
									<td><?php echo sprintf('%0.2f', $CN_17 / $cant); ?></td>
								</tr>
								<tr>
									<td>61</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 18</td>
									<td><?php echo sprintf('%0.2f', $CN_18 / $cant); ?></td>
								</tr>
								<tr>
									<td>62</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 19</td>
									<td><?php echo sprintf('%0.2f', $CN_19 / $cant); ?></td>
								</tr>
								<tr>
									<td>63</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 20</td>
									<td><?php echo sprintf('%0.2f', $CN_20 / $cant); ?></td>
								</tr>
								<tr>
									<td>64</td>
									<td>Proporción de estudiantes con 'No'  en afirmación 21</td>
									<td><?php echo sprintf('%0.2f', $CN_21 / $cant); ?></td>
								</tr>
								<tr>
									<td>65</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 1</td>
									<td><?php echo $CS_1; ?></td>
								</tr>
								<tr>
									<td>66</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 2</td>
									<td><?php echo $CS_2; ?></td>
								</tr>
								<tr>
									<td>67</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 3</td>
									<td><?php echo $CS_3; ?></td>
								</tr>
								<tr>
									<td>68</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 4</td>
									<td><?php echo $CS_4; ?></td>
								</tr>
								<tr>
									<td>69</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 5</td>
									<td><?php echo $CS_5; ?></td>
								</tr>
								<tr>
									<td>70</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 6</td>
									<td><?php echo $CS_6; ?></td>
								</tr>
								<tr>
									<td>71</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 7</td>
									<td><?php echo $CS_7; ?></td>
								</tr>
								<tr>
									<td>72</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 8</td>
									<td><?php echo $CS_8; ?></td>
								</tr>
								<tr>
									<td>73</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 9</td>
									<td><?php echo $CS_9; ?></td>
								</tr>
								<tr>
									<td>74</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 10</td>
									<td><?php echo $CS_10; ?></td>
								</tr>
								<tr>
									<td>75</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 11</td>
									<td><?php echo $CS_11; ?></td>
								</tr>
								<tr>
									<td>76</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 12</td>
									<td><?php echo $CS_12; ?></td>
								</tr>
								<tr>
									<td>77</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 13</td>
									<td><?php echo $CS_13; ?></td>
								</tr>
								<tr>
									<td>78</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 14</td>
									<td><?php echo $CS_14; ?></td>
								</tr>
								<tr>
									<td>79</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 15</td>
									<td><?php echo $CS_15; ?></td>
								</tr>
								<tr>
									<td>80</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 16</td>
									<td><?php echo $CS_16; ?></td>
								</tr>
								<tr>
									<td>81</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 17</td>
									<td><?php echo $CS_17; ?></td>
								</tr>
								<tr>
									<td>82</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 18</td>
									<td><?php echo $CS_18; ?></td>
								</tr>
								<tr>
									<td>83</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 19</td>
									<td><?php echo $CS_19; ?></td>
								</tr>
								<tr>
									<td>84</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 20</td>
									<td><?php echo $CS_20; ?></td>
								</tr>
								<tr>
									<td>85</td>
									<td>Cantidad de estudiantes con 'Sí'  en afirmación 21</td>
									<td><?php echo $CS_21; ?></td>
								</tr>
								<tr>
									<td>86</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 1</td>
									<td><?php echo sprintf('%0.2f', $CS_1 / $cant); ?></td>
								</tr>
								<tr>
									<td>87</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 2</td>
									<td><?php echo sprintf('%0.2f', $CS_2 / $cant); ?></td>
								</tr>
								<tr>
									<td>88</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 3</td>
									<td><?php echo sprintf('%0.2f', $CS_3 / $cant); ?></td>
								</tr>
								<tr>
									<td>89</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 4</td>
									<td><?php echo sprintf('%0.2f', $CS_4 / $cant); ?></td>
								</tr>
								<tr>
									<td>90</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 5</td>
									<td><?php echo sprintf('%0.2f', $CS_5 / $cant); ?></td>
								</tr>
								<tr>
									<td>91</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 6</td>
									<td><?php echo sprintf('%0.2f', $CS_6 / $cant); ?></td>
								</tr>
								<tr>
									<td>92</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 7</td>
									<td><?php echo sprintf('%0.2f', $CS_7 / $cant); ?></td>
								</tr>
								<tr>
									<td>93</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 8</td>
									<td><?php echo sprintf('%0.2f', $CS_8 / $cant); ?></td>
								</tr>
								<tr>
									<td>94</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 9</td>
									<td><?php echo sprintf('%0.2f', $CS_9 / $cant); ?></td>
								</tr>
								<tr>
									<td>95</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 10</td>
									<td><?php echo sprintf('%0.2f', $CS_10 / $cant); ?></td>
								</tr>
								<tr>
									<td>96</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 11</td>
									<td><?php echo sprintf('%0.2f', $CS_11 / $cant); ?></td>
								</tr>
								<tr>
									<td>97</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 12</td>
									<td><?php echo sprintf('%0.2f', $CS_12 / $cant); ?></td>
								</tr>
								<tr>
									<td>98</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 13</td>
									<td><?php echo sprintf('%0.2f', $CS_13 / $cant); ?></td>
								</tr>
								<tr>
									<td>99</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 14</td>
									<td><?php echo sprintf('%0.2f', $CS_14 / $cant); ?></td>
								</tr>
								<tr>
									<td>100</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 15</td>
									<td><?php echo sprintf('%0.2f', $CS_15 / $cant); ?></td>
								</tr>
								<tr>
									<td>101</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 16</td>
									<td><?php echo sprintf('%0.2f', $CS_16 / $cant); ?></td>
								</tr>
								<tr>
									<td>102</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 17</td>
									<td><?php echo sprintf('%0.2f', $CS_17 / $cant); ?></td>
								</tr>
								<tr>
									<td>103</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 18</td>
									<td><?php echo sprintf('%0.2f', $CS_18 / $cant); ?></td>
								</tr>
								<tr>
									<td>104</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 19</td>
									<td><?php echo sprintf('%0.2f', $CS_19 / $cant); ?></td>
								</tr>
								<tr>
									<td>105</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 20</td>
									<td><?php echo sprintf('%0.2f', $CS_20 / $cant); ?></td>
								</tr>
								<tr>
									<td>106</td>
									<td>Proporción de estudiantes con 'Sí'  en afirmación 21</td>
